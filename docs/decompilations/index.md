...
## Decompilation Table of Contents
...
[Back to the Top](#decompilation-table-of-contents)
...
5. Move the `lilipod` or `podman` file to `$HOME/.local/bin/`
...
1. Download the custom textures from the pinned comment on this Youtube Video: [https://www.youtube.com/watch?v=lX1gBO1INZ4](https://www.youtube.com/watch?v=lX1gBO1INZ4) to `$HOME/Applications/OpenGOAL`
...
1. Download attached `.sh` file
    * [PerfectDark.sh](../files/PerfectDark.sh)
...
1. Download the latest model pack: [https://github.com/Render96/ModelPack/releases](https://github.com/Render96/ModelPack/releases) to `$HOME/Downloads`
...
1. Download attached `.sh` file
    * [SuperMario64Plus.sh](../files/SuperMario64Plus.sh)
    * **Note:** If you are using different folder locations, make sure to edit the above file and edit the paths
2. Place in `$HOME/Applications`
    * If you are using EmulationStation-DE or Steam ROM Manager, place in `Emulation/roms/desktop` instead
        * See [How to Add Decompilations and Reverse Engineered PC Ports to Steam](#how-to-add-decompilations-and-reverse-engineered-pc-ports-to-steam) for instructions
...
5. Place your `Super Mario World` ROM in `$HOME/Distrobox/Applications/smbll`
...
3. A `smbll` folder will be created, place your `Super Mario All-Stars` ROM in `$HOME/Distrobox/Applications/smbll/other`
    * SHA256 Hash: `c05817c5b7df2fbfe631563e0b37237156a8f6b6`
    * To locate your SHA256 Hash, right click your ROM, click `Properties`, click `Checksums`, click `Calculate` to the left of `SHA1` and compare it to the above hash. If it is a match, you have a valid ROM
...
1. In `$HOME/Applications/Distrobox/smbll/other`, right click anywhere in the folder, click `Open Terminal Here`, enter:
    * `distrobox enter ubuntu`
2. Enter: 
    * `python3 extract.py`
3. Change directories to `$HOME/Applications/Distrobox/smbll` by entering the following:
    * `cd ..`  
    * If you are not comfortable with the terminal, you may also open a terminal in `$HOME/Applications/Distrobox/smbll`, enter the Distrobox again by entering: `distrobox enter ubuntu`
4. Enter:
    * `make` 
5. Wait for it to finish building
...
4. A `smw` folder will be created, place your Super Mario World ROM in `$HOME/Applications/smw`
    * SHA256 Hash: `6b47bb75d16514b6a476aa0c73a683a2a4c18765`
    * To locate your SHA256 Hash, right click your ROM, click `Properties`, click `Checksums`, click `Calculate` to the left of `SHA1` and compare it to the above hash. If it is a match, you have a valid ROM
...
4. A `sm` folder will be created, place your US Super Metroid ROM in `$HOME/Applications/sm`
...
4. A `sm-redux` folder will be created, place your patched US Super Metroid ROM in `$HOME/Applications/sm-redux`
...
4. A `zelda3` folder will be created, place your US Link to the Past ROM in `$HOME/Applications/zelda3`
...
1.  Download `Alternative New Soundtrack For Randomizers by JUD6MENT (updated: Sep 27, 2021)` from: [https://www.zeldix.net/t791-the-legend-of-zelda-a-link-to-the-past](https://www.zeldix.net/t791-the-legend-of-zelda-a-link-to-the-past) to your `$HOME/Downloads` folder
...
2. Download the latest version of Zelda64, [https://github.com/Zelda64Recomp/Zelda64Recomp/releases](https://github.com/Zelda64Recomp/Zelda64Recomp/releases) to `$HOME/Applications/Zelda64`
...
1. Open the `$HOME/.config/Zelda64Recompiled` folder
...
1. Download the latest `Linux` version of `2Ship2Harkinian`: [https://github.com/HarbourMasters/2ship2harkinian/releases](https://github.com/HarbourMasters/2ship2harkinian/releases) to `$HOME/Applications/2Ship2Harkinian`
    * Download the `2Ship-VERSION-NAME-Linux.zip` file
...
1. Download the latest `Linux-Performance` version of `Ship of Harkinian`: [https://github.com/HarbourMasters/Shipwright/releases](https://github.com/HarbourMasters/Shipwright/releases) to `$HOME/Applications/ShipofHarkinian`
    * Download the `SoH-VERSION-NAME-Linux-Performance.zip` file
2. Right click the downloaded zip file and click `Extract > Extract archive here`
...
1. Download the latest version of Zelda64, [https://github.com/Zelda64Recomp/Zelda64Recomp/releases](https://github.com/Zelda64Recomp/Zelda64Recomp/releases) to `$HOME/Applications/Zelda64` 
    * Download the `Zelda64Recompiled-v*.*.*-Linux-x64-AppImage.zip` file
...
3. Download PokeMMO: [https://pokemmo.com/downloads/linux/](https://pokemmo.com/downloads/linux/) to `$HOME/Games/PokeMMO`
...
1. Download attached `.sh` file
    * [Sonic3AIR.sh](../files/Sonic3AIR.sh)
2. Place in `$HOME/Applications`
