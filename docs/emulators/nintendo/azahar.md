...
4. Type the following command and press enter after typing the command:
    ...
    * {{ flatseal }}
5. Azahar will now be installed and properly configured
...
Read: [https://3ds.hacks.guide/dumping-titles-and-game-cartridges.html](https://3ds.hacks.guide/dumping-titles-and-game-cartridges.html) to learn how to properly dump your DLC and update files from your 3DS.
...
Use [https://jesuscc1993.github.io/miscellaneous/azahar-layout-generator/](https://jesuscc1993.github.io/miscellaneous/azahar-layout-generator/) to create custom layouts.
